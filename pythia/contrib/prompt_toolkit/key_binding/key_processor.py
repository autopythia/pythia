...
# from pythia.contrib.prompt_toolkit.application.current import get_app
from pythia.contrib.prompt_toolkit.enums import EditingMode
# from pythia.contrib.prompt_toolkit.filters.app import vi_navigation_mode
from pythia.contrib.prompt_toolkit.keys import Keys
from pythia.contrib.prompt_toolkit.utils import Event

# from .key_bindings import Binding, KeyBindingsBase

# if TYPE_CHECKING:
#     from pythia.contrib.prompt_toolkit.application import Application
#     from pythia.contrib.prompt_toolkit.buffer import Buffer
...
class KeyProcessor:
    ...
    def _call_handler(self, handler: "Binding", key_sequence: list[KeyPress]) -> None:
        ...
        # Call handler.
        from pythia.contrib.prompt_toolkit.buffer import EditReadOnlyBuffer
