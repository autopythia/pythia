...
if TYPE_CHECKING:
    from pythia.contrib.prompt_toolkit.input.base import Input
    from pythia.contrib.prompt_toolkit.output.base import Output
...
class AppSession:
    ...
    def output(self) -> Output:
        if self._output is None:
            from pythia.contrib.prompt_toolkit.output.defaults import create_output
...
def create_app_session_from_tty() -> Generator[AppSession, None, None]:
    ...
    Usage::
        ...
        from pythia.contrib.prompt_toolkit.shortcuts import prompt
